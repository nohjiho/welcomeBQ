 ...
 */
/**
 * 파이프라인 맵(병렬처리)리듀스(결과 취합) TOP N RANK
 * ParDo로 되어있는 부분이 map , 
 * input 경로의 JAVA 파일을 라인별로 읽어들여 keyword로 시작하는 라인의 집합 중 가장 많이 출현하는 문자열의 랭킹과 출현빈도를 output.csv 파일에 저장.
 * @author 웰컴저축은행
 *
 */
public class IsPopular {
	...
	public static interface MyOptions extends PipelineOptions {
		...
		@Default.String("src/main/java/kr/co/bq/dataflow/")
		String getInput();
	...
	public static void execute(String[] args){
		...
		String input = options.getInput() + "StreamDemoConsumer.java";
